...
class TestThirdStepActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        testThirdStepStopSpeakingButton.visibility = if (fromHandFreeMode) View.VISIBLE else View.GONE
    ...
    private fun speak() {
        ...
        val text = "${testThirdStepFirstText.text} ${testThirdStepSecondText.text}"
    ...
    private fun openDecisionActivity(isComeFromVoice: Boolean = false) {
